...
docs/${RELEASE}/ro-crate-preview.html: node_modules/.bin/makehtml docs/${DRAFT}/ro-crate-metadata.json
	
docs/${RELEASE}/context.json: docs/${RELEASE}/ scripts/schema-context.py
	scripts/schema-context.py ${RELEASE} ${TAG} > docs/${RELEASE}/context.json

release/:
	mkdir -p release

release/ro-crate-${TAG}.html: release/ docs/${RELEASE}/index.md
...
release/ro-crate-${TAG}.pdf: release/ docs/${RELEASE}/index.md
	egrep -v '^{:(\.no_)?toc}' docs/${RELEASE}/index.md | \
...
release/ro-crate-context-${TAG}.json: release/ docs/${RELEASE}/context.json
	cp docs/${RELEASE}/context.json release/ro-crate-context-${TAG}.json

release/ro-crate-metadata.json: release/ docs/${RELEASE}/ro-crate-metadata.json
	cp docs/${RELEASE}/ro-crate-metadata.json release/ro-crate-metadata.json

release/ro-crate-preview.html: release/ docs/${RELEASE}/ro-crate-preview.html
