...
There are two export methods developed, both return a [detached RO-Crate](../specification/1.2-DRAFT/structure.html#detached-ro-crate-package) as JSON-LD output:
