...
description: LabID is an all-in-one research data management platform for life-science institutes. It uses RO-Crate as a format to import/export workflows and workflow runs.
...
LabID is an all-in-one FAIR data management platform for life-science, developed at the EMBL Heidelberg ([MODIS](https://www.embl.org/groups/modis/)).  
...
Workflows and Worklow Runs can be imported and exported from various sources including Galaxy, WorkflowHub and Git repositories.  
