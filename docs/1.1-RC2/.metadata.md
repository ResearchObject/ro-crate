...
* This version: <https://w3id.org/ro/crate/1.1-RC2>
* Alternate formats: [Web pages](https://www.researchobject.org/ro-crate/1.1-RC2/),
  [single-page HTML](https://github.com/ResearchObject/ro-crate/releases/download/1.1.0-RC2/ro-crate-1.1.0-RC2.html),
  [PDF](https://github.com/ResearchObject/ro-crate/releases/download/1.1.0-RC2/ro-crate-1.1.0-RC2.html),
...
**Note**: The RO-Crate [JSON-LD context](https://w3id.org/ro/crate/1.1-RC2/context) and JSON-LD examples within this specification are distributed under [CC0 1.0 Universal (CC0 1.0) Public Domain Dedication][CC0]. 
