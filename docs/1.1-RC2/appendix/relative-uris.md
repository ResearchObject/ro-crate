  ...
  "@graph": [
    {
      ...
      "@type": "CreativeWork",
      "conformsTo": {
        "@id": "https://w3id.org/ro/crate/1.1-RC2"
      },
      "about": {
        "@id": "./"
      },
...
WHERE {
  ...
  ?metadatafile dcterms:conformsTo <https://w3id.org/ro/crate/1.1-RC2> .
}
```
...
<http://example.com/crate255/ro-crate-metadata.json> 
  <http://purl.org/dc/terms/conformsTo> 
  <https://w3id.org/ro/crate/1.1-RC2> .
...
```json
{
  "@context": "https://w3id.org/ro/crate/1.1-RC2",
  "@graph": [
    {
