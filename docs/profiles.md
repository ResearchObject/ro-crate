...
A profile of RO-Crate for [Annotated Research Contexts](https://nfdi4plants.org/content/learn-more/annotated-research-context.html) (ARC) being developed by the plant sciences.  The [profile](https://github.com/nfdi4plants/ARC-specification/blob/main/ARC%20specification.md#appendix-conversion-of-arcs-to-ro-crates) adds requirements of the crate to have folders matching the [ISA model](https://isa-specs.readthedocs.io/en/latest/isamodel.html) (Investigation, Study, Assay).   This can be generated by the [arc-to-roc](https://github.com/nfdi4plants/arc-to-roc) tool.
