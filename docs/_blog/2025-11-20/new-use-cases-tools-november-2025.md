---
title:  "New RO-Crate use case in FAIR data management, and new tools for R and Profile Crates"
author: ["Eli Chadwick"]
date: 2025-11-20
related_pages:
    use_cases: [labid, dataplant] # should match items in pages/use_cases
---
...
Two new RO-Crate tools have also been published:
