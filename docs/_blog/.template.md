...
If you want to include an image in your blog post, add the image to the same folder as the post's Markdown file. You can then include the image in the text with the following code:

```
{% include image.html src="image.png" caption="A test image" alt="Description of image" %}
```
