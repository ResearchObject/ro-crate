...
- Extensions to [ro-crate-py](https://github.com/ResearchObject/ro-crate-py/pull/244) Python library: load most relevant subcrates of very large RO-Crates
- Extensions to [ro-crate-rs](https://github.com/intbio-ncl/ro-crate-rs) Rust library: interactive command line interface mode to traverse attached and detatched RO-Crates
